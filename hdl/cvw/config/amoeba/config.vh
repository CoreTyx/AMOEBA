...
// localparam DTLB_ENTRIES = 32'd16;
...
// localparam PMP_G = 32'd4; // grain of 4 bytes is supported for uncached RV32

// // Address space
// localparam logic [63:0] RESET_VECTOR = 64'h0000_0000_8000_0000;
// // localparam logic [63:0] RESET_VECTOR = 64'h00001000;
...
// localparam BTB_SIZE = 32'd6;
// localparam RAS_SIZE = 32'd4;
...
localparam logic ZICNTR_SUPPORTED = 1;
localparam logic ZIHPM_SUPPORTED  = 0;
localparam COUNTERS = 12'd32; // only need 3 but the rest will get synthd out
...
// TLB configuration.  Entries should be a power of 2
localparam ITLB_ENTRIES = 32'd16;
localparam DTLB_ENTRIES = 32'd16;
...
// Tie GPIO outputs back to inputs
localparam logic GPIO_LOOPBACK_TEST = 1; // DISABLE FOR ACTUAL SYNTHESIS
localparam logic SPI_LOOPBACK_TEST  = 1; // DISABLE FOR ACTUAL SYNTHESIS
